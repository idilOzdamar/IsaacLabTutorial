...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene):
    # sim: fizik motoru SimulationContext nesnesi
    # scene: robotları ve objeleri içeren  InteractiveScene
    ...
    while simulation_app.is_running():
        ...
        if count % 500 == 0:
            ...
            #Bu veriler doğrudan simülasyon motoruna yazılır, yani fizik motoru bu değerleri kullanarak nesneyi sahnede o şekilde yerleştirir.
